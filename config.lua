Config = {}
Config.VersionCheck = true -- if true you will get notified when a new version is released
...
---- weapons that arent alowed in safezone
Config.weapons = {
    ...
    "WEAPON_BATTLEAXE", "WEAPON_POOLCUE", "WEAPON_WRENCH", "WEAPON_STONE_HATCHET",
    ...
    "WEAPON_HEAVYSHOTGUN", "WEAPON_DBSHOTGUN", "WEAPON_AUTOSHOTGUN", "WEAPON_ASSAULTRIFLE",
    ...
    "WEAPON_RAYMINIGUN", "WEAPON_GRENADE", "WEAPON_STICKYBOMB", "WEAPON_PROXMINE", "WEAPON_PIPEBOMB",
    "WEAPON_SMOKEGRENADE", "WEAPON_BZGAS", "WEAPON_MOLOTOV", "WEAPON_FIREEXTINGUISHER", "WEAPON_PETROLCAN",
    "WEAPON_SNOWBALL", "WEAPON_FLARE", "WEAPON_BALL", "WEAPON_GRENADE", "WEAPON_BZGAS", "WEAPON_MOLOTOV",
